...
INSERT INTO adresler VALUES('10015','Ağa Sok', '30.Cad.','Antep');-- ana tabloda bu(10015) id olmadigindan hata verir
...
Create table ogrenci3_adres
AS
SELECT id, adres from ogrenciler3;
select * from ogrenciler3
select * from ogrenci3_adres
...
alter table ogrenciler3 DROP CONSTRAINT pk_id1;
--FK'yi silme CONTRAINT silme
alter table ogrenci3_adres DROP CONSTRAINT ogrenci3_adres_id_fkey;
...
--id'si 1001,1002 veya 1004 olan personelin bilgilerini listele

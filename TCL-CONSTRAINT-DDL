...
-- Tabloya veri ekleme, tablodan veri guncelleme ve silme islemlerinde kullanilan komutlardir
--INSERT
...
-- Transaction veritabani sistemlerinde bir islem basladiginda baslar ve isle bitince sona erer
...
alter table personel1 drop column sirket;
-- Personel tablosundaki sehir sutununun adını ulke olarak değiştirelim
alter table personel1 rename sehir to ulke;
